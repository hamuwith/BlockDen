...
public class MapManager : MonoBehaviour
{
    ...
    public bool IsTool(Vector3Int pos)
    {
        ...
        return Blocks[pos.x, pos.y, pos.z]?.ItemState.ItemType == ItemCategory.Weapon || IsHouse(pos);
    }
    public bool IsBlock(Vector3Int pos)
    {
        ...
        return Blocks[pos.x, pos.y, pos.z]?.ItemState.ItemType == ItemCategory.NatureBlock || Blocks[pos.x, pos.y, pos.z]?.ItemState.ItemType == ItemCategory.UnnatureBlock;
    }
    ...
    public Item MapUpdate(Vector3Int pos, ItemCategory category, int id)
    {
        ...
        {
            Blocks[pos.x, pos.y, pos.z] = itemManager.InstantiateBlock(category, id, new Vector3Int(pos.x, pos.y, pos.z), transform);
        }
        return Blocks[pos.x, pos.y, pos.z];
    }
