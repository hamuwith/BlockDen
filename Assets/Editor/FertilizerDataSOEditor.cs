...
public class FertilizerDataSOEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        var so = (FertilizerDataSO)target;
    ...
    void DrawShapeGrid(FertilizerDataSO so, FertilizerData item)
    {
    ...
    void DrawRecipeGrid(FertilizerDataSO so, FertilizerData item)
    {
        EnsureSlots(so, item);
    ...
    void EnsureSlots(FertilizerDataSO so, FertilizerData item)
    {
    ...
    void SaveCSV(FertilizerDataSO so)
    {
        ...
        sb.Append("Name,Category,Id,UnitNum,MaxNum,Rate,PlusNum,Speed,ShapeWidth,ShapeHeight");
        ...
        Debug.Log($"FertilizerDataをCSVに保存しました: {path}");
    }
